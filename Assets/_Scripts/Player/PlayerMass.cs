...
{
    public PlayerMass instance;

    public PlayerBlob fakeParent;
    public PlayerClone fakeParentClone;
    ...
    private void Start() 
    {
        ...
        rigidBody.AddRelativeForce(fakeParent.playerMovement.lastJoystickDirection * ((scale * mass) * 12), ForceMode2D.Impulse);
